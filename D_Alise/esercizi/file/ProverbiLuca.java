...
public class ProverbiLuca{
	public static void main(String[] input){
		...
		do{
			//BufferReader ha la proprietà AutoCloseable quindi mettendolo vicino al tri
			// è come se automaticamente mi generasse il metodo close.
			try(BufferedReader br = new BufferedReader(new FileReader("./esercizi/proverbi.txt"))){
