/*
Scrivi un programma che utilizzando le classi java.util chieda:
- la data odierna
...
public class DateOld {
    ...
    public static void main(String[] args) {
        ...
        long differenzaGiorni = DateUtilsOld.differenzaGiorni(data1Str, data2Str);
        ...
        boolean valida = DateUtilsOld.dataValida(anno, mese, giorno);
        if (valida) {
        ...
        String esito = DateUtilsOld.annoBisestile(annoBisestile);
        ...
        String giornoSettimana = DateUtilsOld.giornoSettimana(dataStr);
        ...
        String differenza = DateUtilsOld.differenzaTempo(data1, data2);
        ...
        String dataFormattata = DateUtilsOld.formattaData(data);
        System.out.println("Data formattata: " + dataFormattata);
            
        // Ora corrente "HH:mm:ss"
        System.out.println("");
        String oraFormattata = DateUtilsOld.formattaOraCorrente();
        ...
        System.out.println("La differenza di età tra le due persone è di " + DateUtilsOld.calcolaDifferenzaEta(dataPrimo, dataSecondo));
        ...
        String dataScadenza = DateUtilsOld.dataScadenzaContratto(dataInizio, durata);
