...
function initialize() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const business = new Business_1.Business(storage);
            ...
            app.get('/books/:isbn', (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const book = yield business.readById(+req.params.isbn); // Esegui il cast di 'isbn' a 'number'
            ...
            app.put('/books/:isbn', (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    yield business.update(+req.params.isbn, aggiornato); // Esegui il cast di 'isbn' a 'number'
            ...
            app.delete('/books/:isbn', (req, res) => __awaiter(this, void 0, void 0, function* () {
                try {
                    yield business.delete(+req.params.isbn); // Esegui il cast di 'isbn' a 'number'
